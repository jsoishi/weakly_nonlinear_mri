...
def find_crit(comm, R1, R2, Omega1, Omega2, beta, xi, Pm, Rm_min, Rm_max, k_min, k_max, n_Rm, n_k, nr, insulate, sparse=True):
    ...
    if comm.rank == 0:
        ...
        if xi == 0:
            title_str = '../figs/widegap_growth_rates_Pm{}_xi{}_res{0:d}_Rmmin{1:5.02e}_Rmmax{2:5.02e}_kmin{3:5.02e}_kmax{4:5.02e}_nRm{5:5.02e}_nk{6:5.02e}'.format(Pm, xi, nr,Rm_min,Rm_max, k_min, k_max, n_Rm, n_k)
        else:
            title_str = '../figs/helical_growth_rates_Pm{}_xi{}_res{0:d}_Rmmin{1:5.02e}_Rmmax{2:5.02e}_kmin{3:5.02e}_kmax{4:5.02e}_nRm{5:5.02e}_nk{6:5.02e}'.format(Pm, xi, nr,Rm_min,Rm_max, k_min, k_max, n_Rm, n_k)
