...
date
mpiexec_mpt -np 400 python3 $dedalus_script.py --R1=1 --R2=2 --Omega1=313.55 --Omega2=87.794 --Pm=1.0E-6 --beta=0.0174 --xi=4.0 --Rm_min=1.0E2 --Rm_max=1.0E4 --k_min=1.0E-1 --k_max=50.0 --insulate=1
date
