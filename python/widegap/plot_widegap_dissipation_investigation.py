...
ax1.plot(rgrid, base_flow_zavg, color="black", label=r"$u_\phi^{0}$")
ax1.plot(rgrid, uphifinal_zavg, color="blue", label=r"$u_\phi^{final}$")

ax2.plot(rgrid, Bzinitial_zavg, color="black", label=r"$B_z^{0}$")
ax2.plot(rgrid, Bzfinal_zavg, color="blue", label=r"$B_z^{final}$")

ax3.plot(rgrid, nabla_u_zavg, color="orange", label=r"$\frac{1}{Re}|\nabla^2 u|$")
ax3.plot(rgrid, nabla_B_zavg, color="green", label=r"$\frac{1}{Rm}|\nabla^2 B|$")
...
ax1.plot(rgrid, uphifinal_zavg - base_flow_zavg, color="black", label=r"$u_\phi^{final} - u_\phi^{0}$")
ax2.plot(rgrid, Bzfinal_zavg - Bzinitial_zavg, color="black", label=r"$B_z^{final} - B_z^{0}$")
ax3.plot(rgrid, nabla_u_zavg, color="orange", label=r"$\frac{1}{Re}|\nabla^2 u|$")
ax4.plot(rgrid, nabla_B_zavg, color="green", label=r"$\frac{1}{Rm}|\nabla^2 B|$")
...
ax1.plot(rgrid[nz/4.:3*nz/4.], uphifinal_zavg[nz/4.:3*nz/4.]  - base_flow_zavg[nz/4.:3*nz/4.], color="black", label=r"$u_\phi^{final} - u_\phi^{0}$")
ax2.plot(rgrid[nz/4.:3*nz/4.], Bzfinal_zavg[nz/4.:3*nz/4.] - Bzinitial_zavg[nz/4.:3*nz/4.], color="black", label=r"$B_z^{final} - B_z^{0}$")
ax3.plot(rgrid[nz/4.:3*nz/4.], nabla_u_zavg[nz/4.:3*nz/4.], color="orange", label=r"$\frac{1}{Re}|\nabla^2 u|$")
ax4.plot(rgrid[nz/4.:3*nz/4.], nabla_B_zavg[nz/4.:3*nz/4.], color="green", label=r"$\frac{1}{Rm}|\nabla^2 B|$")
...
with h5py.File(out_fn,'w') as f:
    rgrid = f.create_dataset("rgrid", data=rgrid)
