...
$\partial_t \nabla^2 \Psi \, + \, J\left(\Psi, \partial_x^2 \Psi\right) \, - \, 2 \partial_z u_{1y} \, = \, \frac{1}{4\pi} B_0 \partial_z \nabla^2 A \, + \, J\left(A, \nabla^2 A \right) \, + \, \frac{1}{\reye}\nabla^4 \Psi$ \\
...
%$\left[\begin{smallmatrix}{}s \left(- k_{x}^{2} - k_{z}^{2}\right) - \frac{1}{Re} \left(k_{x}^{4} + 2 k_{x}^{2} k_{z}^{2} + k_{z}^{4}\right) & 2 i k_{z} & \frac{i B_{0} k_{z}}{4 \pi} \left(- k_{x}^{2} - k_{z}^{2}\right) & 0\\\i k_{z} \\left(- \\Omega_{0} q + 2\\right) & s - \\frac{1}{Re} \\left(- k_{x}^{2} - k_{z}^{2}\\right) & 0 & - \\frac{i B_{0} k_{z}}{4 \\pi}\\\\- i B_{0} k_{z} & 0 & s - \\frac{1}{Rm} \\left(- k_{x}^{2} - k_{z}^{2}\\right) & 0\\\\0 & - i B_{0} k_{z} & i \\Omega_{0} k_{z} q & s - \\frac{1}{Rm} \\left(- k_{x}^{2} - k_{z}^{2}\\right)\end{smallmatrix}\right]$
