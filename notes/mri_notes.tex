...
$P_1 = P_0 + \frac{\delta^2}{\epsilon^2}\partial_i p$ where $P_0$ is a constant that gets absorbed into $P_b$. \\

This is equivalent to taking $\delta = \epsilon^2$. Making these substitutions and taking $\rho_1 = 0$, we obtain: \\

$\partial_t u_{1x} \, - \, q \Omega_0 x \partial_y u_{1x} \,+ \, \left(\mathbf{u_1} \cdot \nabla\right)u_{1x} \, - \, 2 u_{1y}\,= \, - \, \frac{1}{\rho_b}\partial_x p  \, + \frac{1}{\beta} \frac{1}{4\pi} \frac{1}{\rho_b} \left( B_0 \partial_z B_{1x} \,- \, \frac{B_{1x}^2}{2} \, + \, \mathbf{B_1}\cdot \nabla B_{1x} \right) \, + \, \frac{1}{R_e}\nabla^2 u_x  $ \\

$\partial_t u_{1y}\, - \, q \Omega_0 u_{1x}  \, - \, q \Omega_0 x \partial_y u_{1y} \,+ \, \left(\mathbf{u_1} \cdot \nabla\right)u_{1y} \,+ \, 2u_{1x} \, =  $\\
$\, - \, \frac{1}{\rho_b}\partial_y p \, + \,  \frac{1}{\beta} \frac{1}{4\pi} \frac{1}{\rho_b} \left( B_0 \partial_z B_{1y} \,- \, \frac{B_{1y}^2}{2} \, + \, \mathbf{B_1}\cdot \nabla B_{1y} \right) \, + \, \frac{1}{R_e}\nabla^2 u_y  $ \\

$\partial_t u_{1z} \, - \, q \Omega_0 x \partial_y u_{1z} \,+ \, \left(\mathbf{u_1} \cdot \nabla\right)u_{1z} \, = \, - \, \frac{1}{\rho_b}\partial_z p  \, + \frac{1}{\beta} \frac{1}{4\pi} \frac{1}{\rho_b} \left( B_0 \partial_z B_{1z} \,- \, \frac{B_{1z}^2}{2} \, + \, \mathbf{B_1}\cdot \nabla B_{1z} \right) \, + \, \frac{1}{R_e}\nabla^2 u_x  $ \\
...
$\Omega_0^3 r_0^2 \epsilon^2 \rho_0 \frac{\partial}{\partial t} P \, + \, \Omega_0^3 r_0^2 \epsilon^2 \rho_0 \left(\mathbf{u} \cdot \nabla \right) P \, + \, \Omega_0^3 r_0^2 \epsilon^2 \rho_0 \left(\gamma - 1 \right) P \nabla \cdot \mathbf{u} \, = \, 0 $ \\
...
Substitute in $P_1 = \frac{\delta^2}{\epsilon^2} p$ and $\partial_i \rho_b$ = $\frac{\delta^2}{\epsilon^2} \partial_i \rho_b$ and $\partial_i P_b$ = $\frac{\delta^2}{\epsilon^2} \partial_i P_b$: \\

$\frac{\delta^2}{\epsilon^2}\partial_t p \, - \, \frac{\delta^2}{\epsilon^2}q\Omega_0 x \partial_y p \, + \, \frac{\delta^2}{\epsilon^2}u_{1x}\partial_x P_b \, + \, \frac{\delta^2}{\epsilon^2}u_{z1}\partial_z P_b \, + \, \left(\gamma - 1 \right) P_b \nabla \cdot \mathbf{u_1} \, + \, \frac{\delta^2}{\epsilon^2}\mathbf{u_1} \cdot \nabla p \, \, + \, \frac{\delta^2}{\epsilon^2}\left(\gamma - 1\right)p \nabla \cdot \mathbf{u_1} \, = \, 0$ \\

Drop terms of $\mathcal{O}\left(\frac{\delta^2}{\epsilon^2}\right)$, and we recover:\\
