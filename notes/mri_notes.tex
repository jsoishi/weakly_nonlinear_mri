...
Where $J\left(f, g\right) \equiv \partial_z f \partial_x g - \partial_xf \partial_z g$ \\ 

The x-component of the momentum equation then becomes: \\

$\partial_t\partial_z^2\Psi \, + \, J\left(\Psi, \partial_z^2\Psi\right) \, - \, 2\partial_z u_{1y} \, = \, \frac{1}{4\pi}\partial_z\partial_z\Pi \, + \, \frac{1}{4\pi}B_0 \partial_z^3A \, + \, J\left(A, \partial_z^2A\right) \, + \, \frac{1}{\reye}\nabla^2 \partial_z^2 \Psi$ \\
