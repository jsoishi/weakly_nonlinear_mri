...
\beq
\mathbf{H} = \left[ \begin{matrix}  0 & 0 & 0 & x_0\left(\frac{1}{x^2} - \frac{1}{x}\partial_x\right)\\
0 & 0 & -\frac{x_0}{x^2} & 0 \\ 
0 & 0 & 0 & 0 \\
\frac{x_0}{x^2} & 0 & 0 & 0 \\
\end{matrix} \right] \\
...
\beq
\xi B_0 \mathbf{H} \partial_z \mathbf{V} + \xi B_0 \mathbf{C}
\eeq

Destabilizing substitution $B_0 = 1 - \epsilon^2$:

\beq
\xi \left(1 - \epsilon^2\right) \mathbf{H} \partial_z \mathbf{V} + \xi \left(1 - \epsilon^2\right) \mathbf{C}
\eeq

\beq
= \xi \mathbf{H} \partial_z \mathbf{V}  - \epsilon^2 \xi \mathbf{H} \partial_z \mathbf{V} + \xi \mathbf{C} - \xi \epsilon^2 \mathbf{C}
\eeq

Multiscale expansion ($\partial_z \rightarrow \partial_z + \epsilon \partial_Z$):

\beq
= \xi \mathbf{H} \partial_z \mathbf{V} + \epsilon \xi \mathbf{H} \partial_Z \mathbf{V} - \epsilon^2 \xi \mathbf{H} \partial_z \mathbf{V} - \epsilon^3 \xi \mathbf{H} \partial_Z \mathbf{V} + \xi \mathbf{C} - \xi \epsilon^2 \mathbf{C}
\eeq
...
\beq
\epsilon \xi \mathbf{H} \partial_z \mathbf{V_1} + \epsilon^2 \xi \mathbf{H} \partial_z \mathbf{V_2} + \epsilon^3 \xi \mathbf{H} \partial_z \mathbf{V_3} + \epsilon^2 \xi \mathbf{H} \partial_Z \mathbf{V_1} + \epsilon^3 \xi \mathbf{H} \partial_Z \mathbf{V_2} - \epsilon^3 \xi \mathbf{H} \partial_z \mathbf{V_1} + \xi \mathbf{C} - \xi \epsilon^2 \mathbf{C}
\eeq
...
\beq
\epsilon \xi \mathbf{H} \partial_z \mathbf{V_1}
\eeq
...
\beq
\epsilon^2 \xi \mathbf{H} \partial_z \mathbf{V_2} + \epsilon^2 \xi \mathbf{H} \partial_Z \mathbf{V_1} - \xi \epsilon^2 \mathbf{C}
\eeq

$\mathcal{O}(\epsilon^3)$:

\beq
\epsilon^3 \xi \mathbf{H} \partial_z \mathbf{V_3} + \epsilon^3 \xi \mathbf{H} \partial_Z \mathbf{V_2} - \epsilon^3 \xi \mathbf{H} \partial_z \mathbf{V_1}
\eeq
