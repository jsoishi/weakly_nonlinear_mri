...
$\partial_t u_z \, + \, \left(\mathbf{u} \cdot \nabla\right)u_z \,  =  \, - \, \frac{\epsilon^2}{\delta^2} \frac{1}{\rho} \partial_z P \, +\, \frac{\epsilon^2}{\delta^2} \frac{1}{\beta} \frac{1}{4 \pi \rho} \left( \nabla \times \mathbf{B} \right) \times \mathbf{B} \, + \, \frac{1}{R_e}\nabla^2 u_z $ \\
