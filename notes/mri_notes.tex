...
Beginning with the y component of the induction equation: \\
...
The nonlinear terms are Jacobians: \\

$\partial_t B_{1y} \, = \, B_0 \partial_z u_{1y} \, + \, J\left(A, u_{1y}\right) \, + \, q\Omega_0 x \partial_y B_{1y} \, - \, J\left(\Psi, B_{1y}\right) \, + \, \frac{1}{\reym} \nabla^2 B_{1y} $ \\

Where $J\left(f, g\right) \equiv \partial_z f \partial_x g - \partial_x \partial_z g$ \\
