...
Expanding the incompressibility requirement, we have: \\
...
This is clearly zero always. Thus, we have the stream function $\Psi$, defined such that $\left(u_{x1}, u_{z1}\right) \, = \, \left(\partial_z \Psi, -\partial_x \Psi\right)$.
