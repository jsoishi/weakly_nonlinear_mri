...
$\partial_t\mathcal{D}\mathbf{V} \, + \, \epsilon^2 \partial_T \mathcal{D}\mathbf{V} \, + \, \epsilon^2\partial_Z^2\partial_t\mathcal{D^*}\mathbf{V} \, + \, 2\epsilon\partial_z\partial_Z\partial_t\mathcal{D^*}\mathbf{V} \, + \, \mathbf{N} \, = \, \mathcal{L}\mathbf{V} \, + \, \epsilon\widetilde{\mathcal{L}}_1\partial_Z\mathbf{V} \, + \, \epsilon^2\widetilde{\mathcal{L}}_2\partial_Z^2\mathbf{V} \, - \, \epsilon^2\partial_z\mathcal{X}\mathbf{V} \, - \, \epsilon^2\partial_z^3\mathcal{L}_3\mathbf{V} \, + \, \mathcal{O}(\epsilon^3)$
