...
This work examines Taylor Couette flow in the thin-gap regime, and idealization in which the radial extent of the channel is very small compared to its distance from the center of rotation, i.e. $(r_2 - r_1) \ll \frac{1}{2} (r_1 + r_2)$. The thin-gap approximation eliminates curvature terms, so the domain is Cartesian. These curvature terms have an explicit dependence on $r$, so they make the problem more challenging both analytically and numerically.
