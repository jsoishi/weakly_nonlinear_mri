...
and $B = 0$ at $r = r_1, r_2$ (see \citei{Willis:2002bh}). Here, $I_n$, $K_n$ are the modified Bessel functions of the first and second kind, respectively.
...
We similarly define appropriate boundary conditions for the insulating case. We take the inner product of the adjoint homogenous solution with Equation \ref{eq:ordere3} to find 
