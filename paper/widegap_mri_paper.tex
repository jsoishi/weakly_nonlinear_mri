...
\begin{itemize}
\item detailed comparison to specific experimental apparatus. will gle dynamics be visible? 
\item the vertical dimension is incompletely modeled - stratification, etc
\item explore saturation property dependence of system on rotation profile 
\item different field geometries (e.g. radially varying)
\item other radial boundary conditions
\item drop axisymmetry
