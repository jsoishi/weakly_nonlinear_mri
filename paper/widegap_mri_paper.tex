...
This is the first weakly nonlinear analysis of the MRI in a cylindrical geometry, and the theory developed here should be compared to analytic studies of the MRI in local approximations \citep{Umurhan:2007hs,Vasil:2015}. We find that the saturation amplitude of the standard MRI scales somewhat more steeply with $\Pm$ than does this same system system in the narrow gap approximation.
