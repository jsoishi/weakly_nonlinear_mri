...
\item Other nonideal MHD effects such as the Hall effect and ambipolar diffusion are straightforward addions to this model, and are of particular interest for understanding protoplanetary disks. 
...
\item Our theory can be compared to simulations in both the weakly and strongly nonlinear regimes: both in the pattern selection at saturation and the $\Pm^{0.777}$ scaling can be directly tested. 
\end{itemize}
