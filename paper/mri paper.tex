...
must be satisfied in order for Equation \ref{ordere2} to have a solution.

\section{Results}

\begin{figure*}[h!]
\centering
\includegraphics[scale=0.3]{firstorder_velocity.eps}
\caption{First order velocity perturbations. Streamlines represent velocity in the vertical-radial plane, where thicker streamlines correspond to faster speeds. The colorbar represents azimuthal velocity.}
\end{figure*}
