...
\edit1{We analyze the average energy and angular momentum transport in the simulation domain (Figure \ref{fig:sim_theory_energy_jdot}). We find good agreement between the theory and simulation values, especially considering that the weakly nonlinear theory applies rigorously to a channel of infinite height, while the simulation was carried out in a box with a vertical extent of only two critical wavelengths. Further comparisons between simulation and theory, including an analysis of the effect of the box height on the simulated flow, is deferred to future work. }
