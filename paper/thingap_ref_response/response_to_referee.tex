...
\textbf{The amplitude $\alpha$ is bounded by the value +/- $(b/c)^{1/2}$, although the amplitude does not necessarily converge to a constant value, as shown in Figures 9 and 10 (previously 6 and 7) in Paper I. We note, however, that although the value of the quantity $(b/c)^{1/2}$ is heavily influenced by the boundary layers in the walled TC flow, this is specific to the wall-like boundary conditions and not inherent to the theory. We have added a paragraph at the end of Paper I's section 6 to elaborate on this point, discuss what the $(b/c)^{1/2}$ saturation amplitude means physically, and describe how the derived amplitude applies to the shearing box MRI. We also confirmed numerical convergence in the Paper II geometry and added a sentence noting convergence in the text.}
...
\textbf{Yes, the saturated Bz is marginally stable, and we have added a sentence to note this in the text. We cannot comment on dynamo action in either paper because of the symmetries in our setup. No dynamo can arise from an axisymmetric system (e.g. Cowling's anti-dynamo theorem).}
...
%\textbf{We have carried out a direct numerical situation of the thin-gap TC flow with Dedalus and have added a new section (``Simulations") discussing the results.}
  ...
  \textbf{We have added a new section including a direct numerical simulation run with Dedalus, and made a preliminary comparison at modest Pm. See Section 5 and Figure 6.}
