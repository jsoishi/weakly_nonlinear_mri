...
From the behavior of the second order velocity perturbations (Figure \ref{u_secondorder_by_Pm}) in the bulk of the flow (i.e. apart from the boundary layers), we gather that the MRI is saturating via a background shear reduction.
