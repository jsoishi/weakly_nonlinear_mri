...
The multiscale expansion of the operators and the perturbation series expansion of the fluid quantities combine to make the expansion of the nonlinear vector $\mathbf{N}$ expansive, and we relegate the expansion to Appendix \ref{app:appendix_nonlinear}. $\mathbf{N}$ becomes 
...
\begin{subappendices}
\begin{widetext}
\section*{Appendix A. Nonlinear term expansion}\label{app:appendix_nonlinear}
