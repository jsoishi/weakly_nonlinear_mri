...
The magnetorotational instability (MRI) is the leading candidate for rapid angular momentum transport in astrophysical disks. The instability arises when a differentially rotating disk is threaded by a vertical magnetic field (\citei{CHANDRASEKHAR:1960wh}). The presence of the magnetic field destabilizes the disk gas, driving turbulence and angular momentum transport.
