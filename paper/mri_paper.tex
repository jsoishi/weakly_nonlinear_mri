...
In the above, the current density $\mathbf{J} = \frac{2}{\beta}\del\times\mathbf{B}$,  Equations \ref{momentum} and \ref{induction} are subject to the magnetic solenoid and incompressibility constraints,
